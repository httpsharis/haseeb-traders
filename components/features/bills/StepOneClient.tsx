        ...
        <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="border-b border-stone-200 pb-5">
                <div className="space-y-1.5">
                    <h2 className="text-2xl font-black text-stone-900 tracking-tight">Invoice Setup</h2>
                    <p className="text-sm font-medium text-stone-500">
                        Select an existing client or add a new one, then configure the bill settings.
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-6 rounded-xl border border-stone-200 shadow-sm flex flex-col h-full">
                    ...
                    <ClientSelector selectedName={clientName} onSelect={handleClientSelect} />
                </div>
...
function ClientSelector({ selectedName, onSelect }: ClientSelectorProps) {
    ...
    const handleBlur = () => {
        ...
        if (searchQuery && selectedName === "") {
            ...
            if (perfectMatch) {
                onSelect(perfectMatch._id, perfectMatch.name);
                setSearchQuery(perfectMatch.name);
            }
        }
    };
        ...
        <div className="space-y-2.5 relative">
            ...
            <div className="flex gap-3">
                <div className="relative flex-1 group">
                    <Search className={`absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 transition-colors ${selectedName ? 'text-green-500' : 'text-stone-400 group-focus-within:text-stone-900'}`} />
                    <Input
            ...
            {showDropdown && (
                <div className="absolute z-20 w-full mt-1 bg-white border border-stone-100 rounded-lg shadow-xl max-h-60 overflow-y-auto animate-in fade-in slide-in-from-top-2 duration-200 py-1">
                    {loading ? (
                        <div className="p-3 text-sm text-stone-400 font-medium text-center">Loading clients...</div>
                    ) : filtered.length === 0 ? (
                        <div className="p-2">
                            <div className="p-3 text-sm text-stone-500 text-center mb-1">No clients found.</div>
                            <Button
                                variant="outline"
...
function AddClientPopup({ initialName = "", onClose, onSuccess }: AddClientPopupProps) {
            ...
            <div className="w-full max-w-md bg-white rounded-xl shadow-2xl overflow-hidden border border-stone-100 animate-in zoom-in-95 duration-200">
                <div className="p-6">
                    <div className="mb-6">
                        ...
                        <p className="text-sm font-medium text-stone-500 mt-1">Create a new profile to start generating invoices.</p>
                    </div>
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
                {/* Issue Date */}
                <div className="space-y-2">
                    <label className="text-[11px] font-bold text-stone-500 uppercase tracking-widest">Issue Date</label>
                    <div className="relative group">
                ...
                {/* Bill Period */}
                <div className="space-y-2">
                    <label className="text-[11px] font-bold text-stone-500 uppercase tracking-widest">Bill Period</label>
                    <div className="relative group">
